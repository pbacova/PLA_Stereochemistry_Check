//Intermolecular radial distribution functions for specific atoms in PLA polymer. Check 100LA.itp file in stereochemistry_check directory for the order of the atoms in the gro file.
	  ...
	  long int numH11[ngridwr];
  	  ...
  	  grH11=(double*)malloc((ngridwr)*sizeof(double));
          ...
          rho=(4.0/3.0)*M_PI*N_all*((grid*grid*grid)/(boxmaxx*boxmaxy*boxmaxz));
           ...
           sprintf(outname,"gr_atom_specific_inter");
